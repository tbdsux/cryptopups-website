  ...
  return (
    <div className="py-20">
      <Container className="w-5/6 flex flex-col lg:flex-row items-center">
        <div>
          <h4 className="text-5xl leading-relaxed font-black tracking-wide">About the Project</h4>
          ...
          <div className="mt-8 grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-6">
            {DiscoverItems.map((d, index) => (
              <Link key={index} href={d.link.url}>
                <a
                  title={d.link.text}
                  className="p-4 md:p-6 rounded-xl bg-warmGray-800 opacity-90 hover:opacity-100"
                >
