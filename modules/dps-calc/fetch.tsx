...
const PUPPYCARDS_API = `https://wax.api.atomicassets.io/atomicassets/v1/assets?owner={{owner}}&collection_name=puppycards&schema_name=pupskincards&page=1&limit=1000&order=desc&sort=asset_id`;
const PUPITEMS_API = `https://wax.api.atomicassets.io/atomicassets/v1/assets?owner={{owner}}&collection_name=pupitems&schema_name=pupskincards&page=1&limit=1000&order=desc&sort=asset_id`;
