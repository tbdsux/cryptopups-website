...
import eventImg from '../../../../../public/_events/shibakart.png';
import Container from '../../../../components/container';
import EventsTimer from '../timer';

const RacerShibaEvent = () => {
  return (
    <div className="pt-24">
      <Container className="w-4/5 mb-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          ...
          <div>
            ...
            <p className="text-base lg:text-lg xl:text-xl tracking-wide mt-3 xl:mt-4 text-gray-700">
              All new <strong>Special Rarity</strong>, Racer Shiba, joins the World of Cryptopups.
        ...
        <div className="float-right flex flex-col">
          <div className="inline-flex items-end my-1">
            <EventsTimer date="02 Oct 2021 04:30 PM UTC" duration={48} />
          </div>
        </div>
      </Container>
    </div>
...
export default RacerShibaEvent;
